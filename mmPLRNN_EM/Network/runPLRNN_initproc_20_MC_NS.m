function [net,OutPar]=runPLRNN_initproc_20_MC_NS(InPar,CtrPar,Cstr,NR,p,opt,tau)
...
%% --- 1.1 ini step: estimate observation model only, S~G
%--------------------------------------------------------------------------
A1=OutPar.A;
W1=OutPar.W;
h1=OutPar.h;
...
OutPar.LL=LL;
net.netI1=OutPar;
%% --- 1.2 ini step: estimating influence of external inputs C, S~G
%--------------------------------------------------------------------------
A1=OutPar.A;
W1=OutPar.W;
h1=OutPar.h;
...
CtrPar.fixedB=1;
CtrPar.fixedG=1;% G to be considered fixed or to be estimated

% fixing the full latent model aside from C(external input):
CtrPar.fixedh=1;
CtrPar.fixedW=1;
CtrPar.fixedA=1;
CtrPar.fixedmu0=1;
...
%% --- 4th step: estimate PLRNN model with B fixed & smaller S<<G
%--------------------------------------------------------------------------
OutPar.S=0.01*eye(M);
OutPar.Inp=InPar.Inp;
OutPar.X=InPar.X;
