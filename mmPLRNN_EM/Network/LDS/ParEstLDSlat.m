function [mu0,W,S,C,h]=ParEstLDSlat(EV,S0,C0,Lb,Ub)
%
...
E2=EV.E2; E3=EV.E3; E3_=EV.E3_;
F3=EV.F3; F5_=EV.F5_; F6_=EV.F6_;
...
if nargin<4 || (isempty(Lb) && isempty(Ub))
    ...
    if nargin<3 || isempty(C0), WhC=reshape(whc,m+1+Minp,m)';
